...
<html lang="en">
    ...
    <body>
        <div class="main">
            ...
            <% ArrayList<String> sizesList = (ArrayList<String>) request.getAttribute("sizesList"); %>
            <% ArrayList<String> quantitiesList = (ArrayList<String>) request.getAttribute("quantitiesList"); %>
            <% for (int i = 0; i < productsList.size(); i++) {%>
            <% Product product = productsList.get(i); %>
            <% String size = sizesList.get(i); %>
            <% String quantity = quantitiesList.get(i); %>
            <div class="danh-sach-san-pham khung">
                ...
                <div class="thanh-tien-container">
                    ...
                    <div class="thanh-tien">
                        <%= MoneyUtil.toString("" + (product.getPrice() * Integer.parseInt(quantity)))%> ₫
                    </div>
                </div>
            </div>        
            <% }%>
            ...
            <div class="giao-hang-san-pham-container khung df">
                ...
                <div class="f1">
                    ...
                    <label class="tieu-de-nho" style="font-size: 18px">Tổng tiền hàng</label>
                    <br>
                ...
                <div class="tinh-tien f1">
                    <div class="thanh-tien-value" style="text-align: right">
            ...
            <div class="phuong-thuc-thanh-toan-container khung">
                ...
                <div class="form-dat-hang-container">
                    <form action="/WebApplication2/post-order-from-cart" method="POST" class="form-dat-hang">
                        <input hidden type="text" name="orderIdsString" id="" value="<%= request.getAttribute("orderIdsString")%>">
