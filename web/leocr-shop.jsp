                        ...
                        <div class="danh-muc khung">
                            ...
                            <div class="df">
                                <div class="danh-muc-item">
                                    <a href="/WebApplication2/products?categoryId=1" target="_blank">
                                ...
                                <div class="danh-muc-item">
                                    <div class="danh-muc-item-img cat-anh-danh-muc ">
                                        <a href="/WebApplication2/products?categoryId=3" target="_blank">
                                    ...
                                    <div class="danh-muc-item">
                                        <a href="/WebApplication2/products?categoryId=2" target="_blank">
                                            <div class="danh-muc-item-img cat-anh-danh-muc ">
                        ...
                        <div class="san-pham-ban-chay khung">
                            ...
                            <div class="danh-sach-san-pham-ban-chay">
                                ...
                                <div class="san-pham-ban-chay-item">
                                    ...
                                    <a href ="/WebApplication2/product-detail?id=<%=featuredProduct.getProductId()%>" target="_blank">
                    ...
                    <div class="phan-loai-doi-tuong khung">
                        <div class="danh-cho-nam doi-tuong">
                            ...
                            <div class="xem-san-pham-cua-doi-tuong">
                                <a href="/WebApplication2/products?productGender=1" target="_blank"><button class="xem-san-pham-btn">SHOP MEN</button></a>
                            </div>
                        </div>
                        <div class="danh-cho-nu doi-tuong">
                            ...
                            <div class="xem-san-pham-cua-doi-tuong">
                                <a href="/WebApplication2/products?productGender=2" target="_blank"><button class="xem-san-pham-btn">SHOP WOMEN</button></a>
                            </div>
                        </div>
                        <div class="danh-cho-tre-em doi-tuong">
                            ...
                            <div class="xem-san-pham-cua-doi-tuong">
                                <a href="/WebApplication2/products?productGender=3" target="_blank"><button class="xem-san-pham-btn">SHOP KID'S</button></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="danh-sach-san-pham-moi">
                            ...
                            <div class="san-pham-moi-item">
                                ...
                                <div class="mo-ta-san-pham-moi">
                                    <a href ="/WebApplication2/product-detail?id=<%=newestProduct.getProductId()%>" target="_blank">
