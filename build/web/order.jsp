...
<body>
    ...
    <div class="container">
        ...
        <!-- <div class="shirt">
            ...
            <div class="club text">Manchester United</div>
            <div class="desc text">2008/09 Home</div>
    ...
    <div class="modal order-info">
        <div class="modal-container">
            ...
            <div class="modal-content">
                ...
                <div class="label-container">
                    <label for="modal__type" class="modal-label">
                        <i class="fa-solid fa-quote-left"></i> Type: 
                    </label>
                ...
                <div class="input-container">
                    <label class="type-info">Manchester United Home Kit</label>
                    <label class="phone-info">0356368539</label>
                    <!--<label class="email-info">kk@gmail.com</label>-->
                    <label class="address-info">Văn Quán, Hà Đông</label>
                    <label class="size-info">S</label>
                    <label class="quantity-info">100</label>
                    <label class="payment-method-info">LionelRonaldoPay</label>
                    <label class="status-info">Wait for the confirmation</label>
                </div>    
                <button type="submit" class="cancel-order-btn modal-submit-btn">Cancel Order</button>
            </div>
        </div>
    </div>
    ...
    <script>
        setTimeout(()=>{
            if(document.querySelector('.user-email').textContent == 'admin@lionelronaldo.com')
                document.querySelector('.cancel-order-btn').textContent = 'Ship this order'
        }, 100)
        const orderInfoModal = document.querySelector('.order-info')
        ...
        orderInfoModal.addEventListener('click', hideModal)
    ...
    <script type="text/babel" src="js/order-react.js"></script>
</body>
</html>